export const Achievements = () => {
  return (
    <section className="px-20 pb-10 text-center">
      ...
      <div className="flex flex-col items-center gap-5">
        ...
        <div className="flex items-start gap-2.5 self-end flex-row-reverse">
          ...
          />
          <div
            className="flex flex-col gap-2.5 border-gray-200 bg-gray-100 
    rounded-s-xl rounded-ee-none rounded-se-none 
    px-4 py-2 dark:bg-gray-700 items-end w-full max-w-[320px]"
          >
            <div className="flex items-center space-x-2 rtl:space-x-reverse">
              <span className="text-sm font-semibold text-gray-900 dark:text-white">
                Bonnie Green
